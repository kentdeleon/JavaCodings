...
public class Main {
	...
	public static void searchItems() {
		System.out.println("Search items by entering the name");
		String item = scanner.nextLine();
...
//		}
		...
		boolean ableToFind = grocery.onFile(item);
		if(ableToFind) {
			System.out.println("Sucessfully find item " + item);
		}else {
			System.out.println("Unable to find item " + item);
		}
	}
